...
ABBREVIATION_MAP = {
    ...
    # CUSTOMIZE: Add your project-specific abbreviations below
...
QUERY_TYPE_PATTERNS = {
    'architecture': {
        'keywords': {'architecture', 'pipeline', 'system', 'component', 'contract', 'design'},
    ...
    'workflow': {
        'keywords': {'workflow', 'process', 'procedure', 'deploy', 'release', 'build'},
        'canonical_file': 'docs/WORKFLOW_REGISTRY.md'
    },
    'changelog': {
        'keywords': {'version', 'changed', 'changelog', 'history', 'update', 'release'},
        'patterns': [r'\bv?\d+\.\d+\b', r'\bversion\s+\d+'],
        'canonical_file': 'docs/CHANGELOG.md'
    },
    # CUSTOMIZE: Add project-specific query types
    # 'metrics': {
    #     'keywords': {'metric', 'measurement', 'score', 'threshold'},
